...
<div class="col-sm-3 mb-3">
          <div class="card">
            <img class="card-img-top" width='80' src="../data-admin/image/<?php echo $foto; ?>" alt="gambar">
            <div class="card-body">
              <h5 class="card-title"><?php echo $judul; ?></h5>
              <p class="card-text">Penerima <?php echo $nama_penerima; ?></p>
              <p class="card-text">Kategori <?php echo $kategori_donasi; ?></p>
              <p class="card-text">Terdanai<?php echo "Rp.".number_format ($terdanai) ?></p>
              <p class="card-text"> Kebbutuhan Dana<?php echo "Rp.".number_format ($kebutuhan_dana) ?></p>
          </div>
      </div>
        </div>
      </div>
