...
$result = mysqli_query($mysqli, "SELECT * FROM campaing ORDER BY id_cam DESC");
?>
	...
	<center>
		...
		<table width='80%' border=0>
			...
			while ($res = mysqli_fetch_array($result)) {
				...
				echo "<td><a href=\"editcampaign.php?id_cam=$res[id_cam]\" class=\"btn btn-warning\" role=\"button\">Edit</a> 
				<a href=\"deletecampaign.php?id_cam=$res[id_cam]\" class=\"btn btn-danger\" role=\"button\" onClick=\"return confirm('Kamu yakin untuk delete ini?')\">Delete</a>
				</td>";
			}
			?>
		</table>
